package com.cucumber.commonutils;
...
import com.cucumber_webdriver.CommonBrowser;
...
public class CommonUtlis {
	...
	private static CommonUtlis baseclassinstance = null;

	private CommonUtlis() {
	}

	public static CommonUtlis getInstance() {
		if (baseclassinstance == null) {
			baseclassinstance = new CommonUtlis();
		}
	...
	public void getUrl() throws Throwable {
		try {
			CommonBrowser.getDriver().get("DD");
